...
public:
  ...
  const std::vector<double>& getNValues() const { // Added by Nikola Surjanovic
    return n_values;
  }
  const std::vector<double>& getY2Values() const { // Added by Nikola Surjanovic
    return y2_values;
  }
  const std::vector<double>& getMeanYValues() const { // Added by Nikola Surjanovic
    return meany_values;
  }
...
protected:
  ...
  // Added by Nikola Surjanovic: Number of observations in each internal or terminal node
  std::vector<double> n_values;
  
  // Added by Nikola Surjanovic: Sum of squared responses in each internal or terminal node
  std::vector<double> y2_values;
  
  // Added by Nikola Surjanovic: Mean of responses in each internal or terminal node
  std::vector<double> meany_values;
