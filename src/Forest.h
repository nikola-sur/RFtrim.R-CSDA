...
public:
  ...
  std::vector<std::vector<double>> getNValues() { // Added by Nikola Surjanovic
    std::vector<std::vector<double>> result;
    for (auto& tree : trees) {
      result.push_back(tree->getNValues());
    }
    return result;
  }
  std::vector<std::vector<double>> getY2Values() { // Added by Nikola Surjanovic
    std::vector<std::vector<double>> result;
    for (auto& tree : trees) {
      result.push_back(tree->getY2Values());
    }
    return result;
  }
  std::vector<std::vector<double>> getMeanYValues() { // Added by Nikola Surjanovic
    std::vector<std::vector<double>> result;
    for (auto& tree : trees) {
      result.push_back(tree->getMeanYValues());
    }
    return result;
  }
