...
RcppExport SEXP _ranger_alphaTrim(SEXP tree_str_list_inSEXP, SEXP alphaSEXP, SEXP criterionSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::List >::type tree_str_list_in(tree_str_list_inSEXP);
    Rcpp::traits::input_parameter< const double >::type alpha(alphaSEXP);
    Rcpp::traits::input_parameter< const Rcpp::String >::type criterion(criterionSEXP);
    rcpp_result_gen = Rcpp::wrap(alphaTrim(tree_str_list_in, alpha, criterion));
    return rcpp_result_gen;
END_RCPP
}
// permuteDF
Rcpp::DataFrame permuteDF(Rcpp::DataFrame data, Rcpp::NumericVector inds, Rcpp::CharacterVector col_names);
RcppExport SEXP _ranger_permuteDF(SEXP dataSEXP, SEXP indsSEXP, SEXP col_namesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::DataFrame >::type data(dataSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type inds(indsSEXP);
    Rcpp::traits::input_parameter< Rcpp::CharacterVector >::type col_names(col_namesSEXP);
    rcpp_result_gen = Rcpp::wrap(permuteDF(data, inds, col_names));
    return rcpp_result_gen;
END_RCPP
}
// predictAllTrees
Rcpp::NumericMatrix predictAllTrees(const Rcpp::NumericMatrix data, const Rcpp::List tree_str_list, const Rcpp::List sample_inds, const Rcpp::NumericVector column_names);
RcppExport SEXP _ranger_predictAllTrees(SEXP dataSEXP, SEXP tree_str_listSEXP, SEXP sample_indsSEXP, SEXP column_namesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::NumericMatrix >::type data(dataSEXP);
    Rcpp::traits::input_parameter< const Rcpp::List >::type tree_str_list(tree_str_listSEXP);
    Rcpp::traits::input_parameter< const Rcpp::List >::type sample_inds(sample_indsSEXP);
    Rcpp::traits::input_parameter< const Rcpp::NumericVector >::type column_names(column_namesSEXP);
    rcpp_result_gen = Rcpp::wrap(predictAllTrees(data, tree_str_list, sample_inds, column_names));
    return rcpp_result_gen;
END_RCPP
}
// rangerCpp
...
static const R_CallMethodDef CallEntries[] = {
    {"_ranger_alphaTrim", (DL_FUNC) &_ranger_alphaTrim, 3},
    {"_ranger_permuteDF", (DL_FUNC) &_ranger_permuteDF, 3},
    {"_ranger_predictAllTrees", (DL_FUNC) &_ranger_predictAllTrees, 4},
